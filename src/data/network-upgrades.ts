...
export const eipTitles: Record<string, EIPInfo> = {
  ...
  '8133': { title: 'Hardfork Naming Conventions', category: 'Meta' },
  ...
  '7568': { title: 'Hardfork Meta Backfill - Berlin to Shapella', category: 'Meta' },
  '6987': { title: 'Hardfork Meta - Shanghai', category: 'Meta' },
  '2387': { title: 'Hardfork Meta - Muir Glacier', category: 'Meta' },
  '1679': { title: 'Hardfork Meta - Istanbul', category: 'Meta' },
  '1716': { title: 'Hardfork Meta - Petersburg', category: 'Meta' },
  '1013': { title: 'Hardfork Meta - Constantinople', category: 'Meta' },
  '609': { title: 'Hardfork Meta - Byzantium', category: 'Meta' },
  '607': { title: 'Hardfork Meta - Spurious Dragon', category: 'Meta' },
  '608': { title: 'Hardfork Meta - Tangerine Whistle', category: 'Meta' },
  '779': { title: 'Hardfork Meta - DAO Fork', category: 'Meta' },
  '606': { title: 'Hardfork Meta - Homestead', category: 'Meta' },
  ...
  '7904': { title: 'Compute Gas Cost Analysis', category: 'Informational' },
  '8261': { title: 'Gas Limit Schedule', category: 'Informational' },
  '7975': { title: 'eth/70 - partial block receipt lists', category: 'Networking' },
  '8070': { title: 'eth/72 - Sparse Blobpool', category: 'Networking' },
  '8136': { title: 'Cell-Level Deltas for Data Column Broadcast', category: 'Networking' },
  '8159': { title: 'eth/71 - Block Access List Exchange', category: 'Networking' },
  '8189': { title: 'snap/2 - BAL-Based State Healing', category: 'Networking' },
...
export const upgradeDescriptions: Record<string, string> = {
  ...
  "Gray Glacier": "Difficulty bomb delay to September 2022",
  "Arrow Glacier": "Difficulty bomb delay to June 2022",
  "Altair": "First Beacon Chain upgrade: Sync committees",
  "London": "EIP-1559 fee market reform",
  "Berlin": "Gas cost optimizations",
  "Muir Glacier": "Difficulty bomb delay to July 2020",
...
export const pairedUpgradeNames: Record<string, string> = {
  ...
  "2024-03-13": "Dencun",
  "2023-04-12": "Shapella",
  "2022-09-15": "Paris (The Merge)",
  "2022-09-06": "Bellatrix (The Merge)",
};

export const rawData: UpgradeData[] = [
  { date: "2026-01-07", upgrade: "BPO2", layer: "execution", type: "execution", eips: ["EIP-8135"] },
  { date: "2025-12-09", upgrade: "BPO1", layer: "execution", type: "execution", eips: ["EIP-8134"] },
