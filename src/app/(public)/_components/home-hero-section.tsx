  ...
  return (
    <section className="relative w-full py-4 sm:py-6 md:py-8">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {/* Centralized Search Box — Floats naturally on the page */}
        <div className="relative mt-8 w-full max-w-2xl">
          <div className="group relative flex w-full items-center rounded-full border border-border/80 bg-background/95 p-1.5 shadow-md backdrop-blur-md transition-all focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/15 hover:border-primary/50 sm:p-2">
            ...
            <input
              ...
              placeholder="Search standard number (e.g. 1559, 20, 7560) or title..."
            ...
            <button
              type="button"
              onClick={() => handleSwoop()}
              className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-primary px-5 py-2.5 text-xs font-bold text-primary-foreground shadow-md transition-all hover:scale-[1.02] hover:bg-primary/90 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-primary/40 sm:px-6 sm:py-3 sm:text-sm"
            >
              <span>Swoop</span>
            ...
            {sanityCheck && (
              ...
              >
                <div
                  ...
                  className={cn(
                    'group flex cursor-pointer items-center justify-between gap-3 rounded-2xl border p-3.5 text-left shadow-sm transition-all hover:shadow-md',
          ...
          <AnimatePresence>
            {isOpen && results.length > 0 && (
              <motion.div
                ...
                className="absolute left-0 right-0 top-full z-50 mt-2 max-h-80 overflow-y-auto rounded-2xl border border-border/80 bg-popover/95 p-1.5 text-left shadow-2xl backdrop-blur-xl"
              >
                ...
                {results.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        'flex cursor-pointer items-center justify-between rounded-xl px-3.5 py-2.5 transition-colors',
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <span
                          className={cn(
                            'rounded-lg border px-2.5 py-0.5 text-xs font-bold shrink-0',
                            repoBadge.style
                          )}
                        >
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
          ...
          {quickPills.map((pill) => (
            <button
              ...
              className="group inline-flex items-center gap-1.5 rounded-full border border-border/60 bg-background/60 px-3 py-1 text-xs font-medium text-foreground transition-all hover:border-primary/50 hover:bg-primary/10 hover:text-primary hover:scale-105"
            >
