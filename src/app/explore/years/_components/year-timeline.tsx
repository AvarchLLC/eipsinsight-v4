...
export function YearTimeline({ years, selectedYear, onYearSelect }: YearTimelineProps) {
  return (
    <div className="relative w-full py-6">
      {/* Timeline line */}
      <div className="absolute left-0 right-0 top-1/2 h-0.5 bg-gradient-to-r from-transparent via-slate-700 to-transparent" />
          ...
          return (
            ...
            >
              ...
              <div className={cn(
                ...
                <div className="font-semibold text-white mb-1">{yearData.year}</div>
                <div className="text-slate-300">{yearData.newEIPs} EIPs</div>
                <div className="text-slate-400">{yearData.statusChanges} changes</div>
